...
int main()
{
	...
	camera = Camera(glm::vec3(28.5f, 5.0f, 40.0f), glm::vec3(0.0f, 1.0f, 0.0f), -60.0f, 0.0f, 30.0f, 0.5f);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		float pelotaBaseX = 28.5f; 
		float pelotaBaseZ = 15.0f;  

		float pelotaAmplitud = 25.0f; 
